...
import 'package:ifix/app/controller/configController.dart';
                ...
                child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(height: 20),
                        RatingBar(
                          initialRating: double.parse(userProvider
                              .userData['configs']['rating']
                              .toString()),
                          minRating: 0,
                        ...
                        FormBuilderSegmentedControl(
                          ...
                          initialValue: userProvider.userData['configs']
                              ['max_distance'],
